...
`http://localhost:8000/docs` — you can call both endpoints from the browser.

## Notes

- The server fetches its token once at startup. That is fine for a demo;
  a service that runs for days should refresh it, since these tokens are
